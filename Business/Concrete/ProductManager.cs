...
namespace Business.Concrete
{
    public class ProductManager : IProductService
    {
        ...
        public IResult Add(Product product)
        {
            ...
            //validation : isim 5 haneli olmalı filan gibi  
        ...
        ///  iş parçacıkları bu şekilde yazılır ve private olur çünkü sadece buradaki classda kullanılıcak
        ...
        {
            var result = _productDal.GetAll(p => p.ProductName == productName).Any(); //buna uyan bir kayıt var mı demek
            if (result)
            {
